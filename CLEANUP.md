...
| `docs/plans/2026-09-14-phase-3-bulk.md` | Phase 3 landed on 2026-09-15 — all seven steps closed, 496 tests, verified against a staging workspace. A plan is deleted when its work lands. Keep until whoever opens Phase 4 has read it: it carries why the executor is a generator, why `unknown` means what it means, and the two measurements nothing else records — Braze's `index`/`input_array` attribution and the 599-of-600 bound. The rulings are already in `DECISIONS.md` | 2026-09-15 |
