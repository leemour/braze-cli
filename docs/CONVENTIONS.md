...
[`../BACKLOG.md`](../BACKLOG.md); something to delete lives in [`../CLEANUP.md`](../CLEANUP.md);
a plan lives in [`plans/`](plans/). Everywhere else links to it. Two copies of a fact drift, and
