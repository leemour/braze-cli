...
which task, how to run the checks, and the ten rules that cost time when broken. Everything else
...
Generated from the operation catalog once Phase 2 lands, never hand-edited: `commands.md` ·
`catalog-coverage.md`.
